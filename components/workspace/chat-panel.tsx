...
export const ChatPanel = () => {
  ...
  const { setFocusedMessageId, setSplitPaneOpen, setViewMode } = useSessionUiState();
  ...
  React.useEffect(() => {
    ...
    setViewMode("split");
    scrollMessageIntoView(anchorId);
  }, [anchorId, operation, setFocusedMessageId, setSplitPaneOpen, setViewMode]);
