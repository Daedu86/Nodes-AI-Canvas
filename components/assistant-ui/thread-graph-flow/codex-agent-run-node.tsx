...
import { Bot, Check, CheckCircle2, GitBranchPlus, Play, RotateCcw, ShieldQuestion, Square, Trash2, X } from "lucide-react";
...
type AgentScope = "general" | "project" | "selected" | "branch";
  ...
  return <div className={["group relative w-[450px] rounded-2xl border bg-slate-950/95 p-px shadow-[0_24px_60px_-34px_rgba(59,130,246,0.5)] transition-all", selected ? "ring-2 ring-sky-300/80" : "ring-1 ring-white/10"].join(" ")}>
    <div className="relative overflow-hidden rounded-[15px] border border-white/8 bg-slate-950/95 px-4 py-4">
      ...
      <div className="relative mt-4 space-y-3">
        ...
        {completed ? <div className="rounded-xl border border-emerald-300/20 bg-emerald-400/[0.07] px-3 py-2 text-[11px] text-emerald-100/85">Execution completed. The final answer is shown in a separate response node on the canvas.</div> : null}
