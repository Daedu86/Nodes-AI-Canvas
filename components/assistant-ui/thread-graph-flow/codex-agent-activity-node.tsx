...
export const CodexAgentActivityNode = memo(
  ({ data, selected }: NodeProps<ThreadGraphFlowNode>) => {
    ...
    return (
      <div
        className={[
          "relative w-[300px] rounded-xl border bg-slate-950/94 px-3 py-2.5 shadow-[0_16px_44px_-30px_rgba(14,165,233,0.65)]",
      ...
      >
        ...
        <div className="flex items-start gap-2.5">
          <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-sky-300/20 bg-sky-400/10 text-sky-100">
