  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-3 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-[22px] md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-3",
        className
      )}
      {...props}
    />
